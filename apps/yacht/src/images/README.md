# Bali Yacht Catering — images

Drop photos in **this folder**. The filename (without extension) must match a
**slot** below. It then appears automatically on the next build / `pnpm dev:yacht`
...
| --------------------- | -------------------------- | ----------------------------------- | ---------------- |
| `yacht-home-hero`     | Home · hero                | Yacht at sunset off Bali            | Landscape (hero) |
| `yacht-home-plate1`   | Home · split               | Onboard dining / canapés            | ~4:3             |
| `yacht-menus-hero`    | Cruise & Event Menus · hero| Seafood platter / BBQ on deck       | Landscape (hero) |
