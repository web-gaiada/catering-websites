...
| `jet-insights-feature` | Insights · feature       | Plated dish / chef seasoning         | ~4:3             |
| `jet-insights-tarmac`  | Insights · article card  | Tarmac / FBO at night                | ~3:2             |
| `jet-insights-market`  | Insights · article card  | Market / premium ingredients         | ~3:2             |
| `jet-insights-kitchen` | Insights · article card  | Kitchen detail / per-passenger label | ~3:2             |
