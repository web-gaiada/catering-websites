...
| `prov-insights-manifest` | Insights · article card  | Manifest / provisioning crates             | ~3:2             |
| `prov-insights-cellar`   | Insights · article card  | Premium imports / cellar                   | ~3:2             |
| `prov-insights-port`     | Insights · article card  | Benoa Marina / port operations             | ~3:2             |
